...
const PROJECT_ROUTES = { '/projects/basic-chat': 'basic-chat', '/projects/basic-rag': 'basic-rag', '/projects/advanced-rag': 'advanced-rag', '/projects/google-workspace-agent': 'google-workspace-agent', '/projects/chunking-lab': 'chunking-lab', '/projects/graph-rag': 'graph-rag', '/projects/agent-orchestration': 'agent-orchestration', '/projects/simple-agent': 'simple-agent', '/projects/inside-llm': 'inside-llm', '/projects/embed-lab': 'embed-lab', '/projects/decode-lab': 'decode-lab', '/projects/guard-lab': 'guard-lab', '/projects/marketing-copilot': 'marketing-copilot' }
